...
public interface FilmsApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"genreID\" : 1, \"duration\" : 120, \"ArrayActors\" : [ 101, 102, 103 ], \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"release_year\" : 2023, \"description\" : \"Film Sinopsis\", \"id\" : 1, \"title\" : \"Film Title\" }, { \"genreID\" : 1, \"duration\" : 120, \"ArrayActors\" : [ 101, 102, 103 ], \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"release_year\" : 2023, \"description\" : \"Film Sinopsis\", \"id\" : 1, \"title\" : \"Film Title\" } ]";
    ...
    default ResponseEntity<Void> filmsIdDelete(
        @Parameter(name = "id", description = "El ID de la película a eliminar", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    /**
     * GET /films/{id} : Devuelve los detalles de una película específica
     ...
     *
     * @param id El ID de la película a obtener (required)
     * @return Película obtenida con éxito (status code 200)
     *         or (NotFound) El recurso solicitado no existe en la base de datos. (status code 404)
     */
    @Operation(
        operationId = "filmsIdGet",
    ...
    default ResponseEntity<Film> filmsIdGet(
        @Parameter(name = "id", description = "El ID de la película a obtener", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"genreID\" : 1, \"duration\" : 120, \"ArrayActors\" : [ 101, 102, 103 ], \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"release_year\" : 2023, \"description\" : \"Film Sinopsis\", \"id\" : 1, \"title\" : \"Film Title\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    /**
     * PUT /films/{id} : Actualiza una película
     ...
     *
     * @param id El ID de la película a actualizar (required)
    ...
    default ResponseEntity<Film> filmsIdPut(
        @Parameter(name = "id", description = "El ID de la película a actualizar", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id,
