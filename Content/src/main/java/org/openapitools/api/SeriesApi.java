...
public interface SeriesApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"genreID\" : 1, \"ArrayActors\" : [ 101, 102, 103 ], \"seasons\" : 5, \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"release_year\" : 2022, \"description\" : \"Series Sinopsis\", \"id\" : 1, \"title\" : \"Series Title\" }, { \"genreID\" : 1, \"ArrayActors\" : [ 101, 102, 103 ], \"seasons\" : 5, \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"release_year\" : 2022, \"description\" : \"Series Sinopsis\", \"id\" : 1, \"title\" : \"Series Title\" } ]";
     ...
     *
     * @param id El ID de la serie a eliminar (required)
     * @return Serie eliminada con éxito (status code 204)
     *         or (NotFound) El recurso solicitado no existe en la base de datos. (status code 404)
     *         or (BadRequest) Los datos enviados no son correctos o faltan datos obligatorios en la solicitud. (status code 400)
     */
    @Operation(
        operationId = "seriesIdDelete",
    ...
    default ResponseEntity<Void> seriesIdDelete(
        @Parameter(name = "id", description = "El ID de la serie a eliminar", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    /**
     * GET /series/{id} : Devuelve los detalles de una serie específica
     ...
     *
     * @param id El ID de la serie a obtener (required)
    ...
    default ResponseEntity<Serie> seriesIdGet(
        @Parameter(name = "id", description = "El ID de la serie a obtener", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"genreID\" : 1, \"ArrayActors\" : [ 101, 102, 103 ], \"seasons\" : 5, \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"release_year\" : 2022, \"description\" : \"Series Sinopsis\", \"id\" : 1, \"title\" : \"Series Title\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
     ...
     *
     * @param id El ID de la serie a actualizar (required)
    ...
    default ResponseEntity<Serie> seriesIdPut(
        @Parameter(name = "id", description = "El ID de la serie a actualizar", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id,
    ...
    default ResponseEntity<Episode> seriesSerieIDEpisodesEpisodeIDGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"photoURL\" : \"https://example.com/photo.jpg\", \"numTemporada\" : 2, \"titulo\" : \"Episode Title\", \"serieID\" : 101, \"episodeID\" : 1 }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    default ResponseEntity<List<Episode>> seriesSerieIDEpisodesGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"photoURL\" : \"https://example.com/photo.jpg\", \"numTemporada\" : 2, \"titulo\" : \"Episode Title\", \"serieID\" : 101, \"episodeID\" : 1 }, { \"photoURL\" : \"https://example.com/photo.jpg\", \"numTemporada\" : 2, \"titulo\" : \"Episode Title\", \"serieID\" : 101, \"episodeID\" : 1 } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
     ...
     * @param seriesSerieIDEpisodesPostRequest Detalles del nuevo episodio a crear. (required)
    ...
    default ResponseEntity<Void> seriesSerieIDEpisodesPost(
        ...
        @Parameter(name = "SeriesSerieIDEpisodesPostRequest", description = "Detalles del nuevo episodio a crear.", required = true) @Valid @RequestBody SeriesSerieIDEpisodesPostRequest seriesSerieIDEpisodesPostRequest
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
