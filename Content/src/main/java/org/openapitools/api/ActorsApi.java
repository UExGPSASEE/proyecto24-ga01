...
public interface ActorsApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"birthday_date\" : \"2003-07-16\", \"name\" : \"Actor Name\", \"id\" : 1 }, { \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"birthday_date\" : \"2003-07-16\", \"name\" : \"Actor Name\", \"id\" : 1 } ]";
     ...
     *
     * @param id El ID del actor a eliminar (required)
    ...
    default ResponseEntity<Void> actorsIdDelete(
        @Parameter(name = "id", description = "El ID del actor a eliminar", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    /**
     * GET /actors/{id} : Devuelve los detalles de un actor específico
     ...
     *
     * @param id El ID del actor a obtener (required)
     * @return Actor obtenido con éxito (status code 200)
     *         or (NotFound) El recurso solicitado no existe en la base de datos. (status code 404)
     */
    @Operation(
        operationId = "actorsIdGet",
    ...
    default ResponseEntity<Actor> actorsIdGet(
        @Parameter(name = "id", description = "El ID del actor a obtener", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ], \"birthday_date\" : \"2003-07-16\", \"name\" : \"Actor Name\", \"id\" : 1 }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
    ...
    /**
     * PUT /actors/{id} : Actualiza un actor
     ...
     *
     * @param id El ID del actor a actualizar (required)
    ...
    default ResponseEntity<Actor> actorsIdPut(
        @Parameter(name = "id", description = "El ID del actor a actualizar", required = true, in = ParameterIn.PATH) @PathVariable("id") Integer id,
