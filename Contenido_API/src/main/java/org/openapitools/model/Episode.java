...
public class Episode {
   ...
   */
  public Episode(Integer episodeID, Integer serieID, Integer numTemporada, String titulo) {
  ...
  @Schema(name = "photoURL", example = "https://example.com/photo.jpg", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(episodeID, serieID, numTemporada, titulo, photoURL);
  }
